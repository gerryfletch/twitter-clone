...
public class GetTweetsResource {
     ...
     *
     * Example: get/feed/?limit=100&page=1
     *
    ...
    @GET
    @RolesAllowed("user")
    public Response getUserFeed(@HeaderParam("authorization") String auth, @QueryParam("limit") Integer limit, @QueryParam("page") Integer page) {
        ...
        try {
            JsonArray tweets = tweetService.getUserFeed(uid, limit, page);
